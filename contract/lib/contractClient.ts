...
class ContractClient {
  ...
  setSigner() {
    return __awaiter(this, void 0, void 0, function* () {
      if (!this.signer) {
        throw new Error(
          'Requires valid Signer options to be able to set signing method',
        )
      }
      ...
      switch (this.signer.type) {
        case 'key':
          yield (0,
          signer_1.importKey)(this.tezos, this.signer.key.email, this.signer.key.password, this.signer.key.mnemonic.join(' '), this.signer.key.secret)
          this.signerSet = true
          return
        case 'secret':
  ...
  getPKH() {
    return __awaiter(this, void 0, void 0, function* () {
      if (!this.signer) {
        throw new Error(
          'Requires valid Signer options to be able to create PKH',
        )
      }
  ...
  isTZP(contractAddress) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const contract = yield this.tezos.contract.at(
          contractAddress,
          tzip16.tzip16,
        )
  ...
  retrieveAllContracts(offset, walletAddress) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let searchRes = yield axios_1.default.get(
        `${prefix}contracts?creator=${walletAddress}&offset=${offset}&limit=${pageLimit}&sort=firstActivity&select=address`,
      )
      ...
      if (pageCount == pageLimit) {
        return data.concat(
          yield this.retrieveAllContracts(offset + pageCount, walletAddress),
        )
      }
      return data
    })
  ...
  retrieve() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let log = yield this.retrieveClaims()
      return log
    })
  }
  retrieveClaims() {
    return __awaiter(this, void 0, void 0, function* () {
      let storage = yield this.retrieveAndScreenContract()
      let pkh = yield this.getPKH()
      let lastLogOfThisAddress = storage?.logs
  ...
  originate(contentReferenceList) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (prexisting) {
        throw new Error(
          `Cannot originate new smart contract, found existing smart contract at address ${prexisting} for wallet ${pkh}`,
        )
      }
      let contentList = []
      ...
      metadataBigMap.set(
        '',
        tzip16.char2Bytes('https://tzprofiles.com/tzip016_metadata.json'),
      )
  ...
  getContract(address) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!this.signer) {
        throw new Error(
          'Requires valid Signer options to be able to getContract',
        )
      }
      let t = this.signer.type
      switch (this.signer.type) {
  ...
  addClaims() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      // }
      if (entrypoints.includes('published')) {
        try {
          let op = yield contract.methods.published(pkh).send()
          yield op.confirmation(CONFIRMATION_CHECKS)
          return op.hash || op.opHash
        } catch (e) {
          console.log(e)
        ...
        throw new Error(`No entrypoint to add log.`)
      }
    })
  }
  ...
  removeClaims(contractAddress, contentReferenceList) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!this.signer) {
        throw new Error(
          'Requires valid Signer options to be able to removeClaims',
        )
      }
      if (!this.signerSet) {
        yield this.setSigner()
